...
static const char *xrandr[] = { "xrandr", "--output", "eDP-1", "--auto", "--output", "HDMI-2", "--auto", "--output", "HDMI-1", "--auto", "--output", "DP-1", "--auto", "--output", "DP-2", "--auto", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask|Mod1Mask,             XK_e,          quit,                   {0} },
	#if RESTARTSIG_PATCH
